...
// three are the ones that will be useful to display the number of representatives by party
...
tabla +=  "<tr><td>" + "Republicans" + "</td>"+
          ...
          "</tr>";
// The following functions and tables are the ones that get the data about attendance (whom where the congressmen that  
// missed more and less voting)
